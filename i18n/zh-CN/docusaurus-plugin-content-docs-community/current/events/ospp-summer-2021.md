...
- 访问 [这里](https://github.com/orgs/beyondstorage/projects/1?card_filter_query=label%3A%22help+wanted%22) 完成一些 Issue 以对 Beyond Storage 了解更多。
...
我们计划在现有存储服务之外构建一个存储抽象层。 现在，我们正聚焦于 Golang 的实现： [go-sorage](https://github.com/beyondstorage/go-storage)
